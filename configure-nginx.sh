...
sudo curl https://raw.githubusercontent.com/kylesafrin/HW6_scripts/main/default | sudo tee -a /etc/nginx/sites-available/default
...
sudo git clone https://github.com/kylesafrin/HW6_website.git
